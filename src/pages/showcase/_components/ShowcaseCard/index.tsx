...
import { Tags, TagList, type TagType, type ProjectShowcase } from '@site/data/showcase'
...
function getCardImage(user: ProjectShowcase): string {
  return (
    user.preview
...
function ShowcaseCard({ user }: { user: ProjectShowcase }) {
